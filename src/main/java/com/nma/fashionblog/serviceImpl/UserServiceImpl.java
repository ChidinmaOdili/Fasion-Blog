...
import com.nma.fashionblog.exception.PostAlreadyLikedException;
import com.nma.fashionblog.exception.PostNotFoundException;
import com.nma.fashionblog.exception.UserNotFoundException;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(LikeRepo likeRepository, UserRepo userRepository, CommentRepo commentRepository, PostRepo postRepository) {
